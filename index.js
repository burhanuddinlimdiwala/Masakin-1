...
(function() {
  ...
  var layoutToggleElement = document.querySelector('#layoutToggle');
  ...
  function toggleLayout() {
    // Get the hotspot container element
  ...
  document.getElementById('hotspot1').addEventListener('click', function() {
    ...
    var scene = findSceneById("0-living-room");  // Replace with your scene ID
    switchScene(scene);
  });
  
  document.getElementById('hotspot2').addEventListener('click', function() {
    
    var scene = findSceneById("3-kitchen");  // Replace with your scene ID
    switchScene(scene);
  });
  
  document.getElementById('hotspot3').addEventListener('click', function() {
  
    var scene = findSceneById("2-passage");  // Replace with your scene ID
    switchScene(scene);
  });
  document.getElementById('hotspot4').addEventListener('click', function() {
  
    var scene = findSceneById("1-bed-room");  // Replace with your scene ID
    switchScene(scene);
  });
})();
